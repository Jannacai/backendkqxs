...
// const XSMN = mongoose.model('XSMN', xsmnSchema);
...
// async function scrapeXSMN(date, station) {
//     let browser;
//     let intervalId;
//     let finalResults = [];
//     let provincesList = [];
...
//         const existingResult = await XSMN.findOne({ drawDate: dateObj, station: result.station, tentinh: result.tentinh });
...
//             }
//         } else {
//             const latestResult = await XSMN.findOne({
...
//     console.log('Bắt đầu cào dữ liệu XSMN...');
//     const today = new Date().toLocaleDateString('vi-VN', { day: '2-digit', month: '2-digit', year: 'numeric' });
//     scrapeXSMN(today, 'xsmn');
// });
...
// } else {
//     console.log('Nếu muốn chạy thủ công, dùng lệnh: node xsmn_scraper.js 19/04/2025 xsmn');
// }
